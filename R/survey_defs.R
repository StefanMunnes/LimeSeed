...
# Used by lsh_types("all") to group output instead of listing all types in one flat block.

LS_TYPE_GROUPS <- list(
  "List / Radio" = c("5", "!", "L", "O"),
  "Text" = c("S", "T", "U", "Q"),
  "Array" = c("1", "A", "B", "C", "E", "F", "H", ";", ":"),
  "Multiple Choice" = c("M", "P"),
  "Special / Masked" = c("|", "D", "G", "*", "Y", "K", "R", "I", "X", "N")
)
